...
<head>
    ...
    <title>Dashboard pour le Sertisseur</title>
...
<body id="body">
    ...
    <?php include('header_operateur.php'); ?>
    <?php include('aside_operateur.php'); ?>

    <!-- Partie section pour afficher du contenu spécifique -->
    <section id="section">
        <!-- Contenu spécifique de chaque page ici -->
         <h1>Dashboard pour le Sertisseur</h1>
    ...
    if (basename($_SERVER['PHP_SELF']) == 'acceuil_fondeur.php') {
        include('acceuil_fondeur.php');
    } elseif (basename($_SERVER['PHP_SELF']) == 'bijoux_a_reparer.php') {
        include('gestion_taches.php');
    } elseif (basename($_SERVER['PHP_SELF']) == 'missions.php') {
